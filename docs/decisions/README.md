...
| [0006](0006-ledger-and-value-memory-value-in-slot.md) | ~~이름표 장부 │ 값 메모리 두 칸 + 원시값 value-in-slot~~ | Superseded by 0007 |
| [0007](0007-all-values-in-value-memory-model-b.md) | **모든 값을 값 메모리에** — 장부는 이름+화살표만 (model B) | Accepted |
