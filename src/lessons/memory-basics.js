  ...
  const SCENARIO_PUSHPOP = {
    ...
    steps: [
      { line: 3, stack: [{ name: 'main', slots: [{ name: 'say', value: '(대기)', bad: true }] }, { name: 'welcome', slots: [] }], heap: {},
        note: '<b>②프레임 push</b> — <code>welcome("민지")</code> 호출 → 스택에 <b>welcome 칸</b>이 새로 쌓인다. <b>매개변수 name 칸은 아직 비어 있다</b>(바인딩 전). (main의 say는 대기 — 반환을 기다린다)',
      ...
      { line: 0, stack: [{ name: 'main', slots: [{ name: 'say', value: '(대기)', bad: true }] }, { name: 'welcome', slots: [{ name: 'name', value: '"민지"' }] }, { name: 'makeGreeting', slots: [] }], heap: {},
        note: 'welcome 본문에서 <code>makeGreeting(name)</code>을 부른다 → <b>또 push</b>. 이제 프레임 <b>3개</b>(main·welcome·makeGreeting), 맨 위 makeGreeting의 <b>name 칸은 아직 빈칸</b>(바인딩 전).',
