...
;(function () {
  ...
  const SCENARIO_PASSVAL = {
    ...
    steps: [
      ...
      { line: 4, stack: [{ name: 'main', slots: [{ name: 'money', value: '10000' }] }], heap: {}, note: 'tear 끝 → 프레임 <b>pop</b>, bill(복사본) 사라짐. money는 여전히 <b>10000</b>. 원시값은 <b>복사본</b>으로 전달돼 원본이 안전하다.', engine: 'tear 프레임 pop = bill 슬롯 회수. 인라인 원시값이라 힙에 남을 것도 GC 대상도 없다.' },
    ],
  }
