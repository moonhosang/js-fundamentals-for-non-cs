  ...
  const SCENARIO_PUSHPOP = {
    ...
    steps: [
      ...
      { line: 5, stack: [{ name: 'main', slots: [{ name: 'say', value: '(대기)', bad: true }] }, { name: 'welcome', slots: [{ name: 'name', value: '"민지"' }] }], heap: {},
        note: '<b>⑤ makeGreeting 반환·pop</b> — makeGreeting가 값을 반환하고 그 칸이 <b>통째로 pop(사라짐)</b>. 반환값 "안녕, 민지님"은 <b>welcome의 msg 자리로</b> 가는 중 — msg는 <b>아직 대기</b>.',
      ...
      { line: 7, stack: [{ name: 'main', slots: [{ name: 'say', value: '(대기)', bad: true }] }], heap: {},
        note: '<b>⑤ welcome 반환·pop</b> — welcome이 <code>return "🎉 " + msg</code>로 값을 내보내고 <b>pop</b>. name·msg는 <b>사라진다</b>. 반환값은 <b>main의 say 자리로</b> 가는 중 — say는 <b>아직 대기</b>.',
