...
;(function () {
  ...
  const LESSONS = [
    ...
    { id: '3-5', badge: '3-5', title: '3-5 · 🔒 중첩 함수', subtitle: '좌→우·안쪽 먼저 (7강 함수 후)', step: true },
    ...
    { id: 5, badge: '5강', title: '5강 · 배열', subtitle: '여러 값을 목록으로',
      plan: ['배열 만들기 [ ] · 인덱스로 꺼내기', 'length · push 로 추가', '화면: 목록을 여러 칩으로 그리기', '유형 드릴 ×10'] },
    { id: 6, badge: '6강', title: '6강 · 반복과 map', subtitle: '훑기 · 변환하기',
      plan: ['for 로 하나씩 훑기', 'map 으로 목록을 통째로 바꾸기', 'filter 로 거르기', '화면: 데이터 배열 → 카드 목록', '유형 드릴 ×10'] },
    { id: 7, badge: '7강', title: '7강 · 함수', subtitle: '값을 넣으면 값이 나오는 상자',
  ...
  const CHAPTERS = [
    ...
    { n: '3', title: '여러 값과 반복', items: [5, ...P(5), 6, ...P(6), 7, ...P(7), 8, ...P(8)] },
