...
;(function () {
  ...
  E["passval"] = {
    ...
    problems: [
      ...
      {"label":"더해도 안전?","ask":"add1이 +5 해도 a는?","code":"function add1(x) { x = x + 5 }\nlet a = 10\nadd1(a)\nprint(a === ____)","expect":"true","answer":"10","hint":"복사본만 바뀜","explain":"복사본에만 +5 → a는 10.","mem":{"title":"x(함수 안)은 복사본 — a(원본)는 안전","stackLabel":"📇 이름표 장부","code":["let a = 10","add1(a)   // x = 복사 10","x = 15"],"steps":[{"line":1,"stack":[{"name":"main","slots":[{"name":"a","value":"10"}]},{"name":"add1","slots":[{"name":"x","value":"10"}]}],"heap":{},"note":"원시값을 넘기면 <b>값을 복사</b> → x은 별개 셀(10)."},{"line":2,"stack":[{"name":"main","slots":[{"name":"a","value":"10"}]},{"name":"add1","slots":[{"name":"x","value":"15","bad":true}]}],"heap":{},"note":"<code>x=15</code>는 복사본만 바꾼다. <b>a는 10 그대로</b>."}]}},
